...
class TDKNLRGAN_G(nn.Module):
    def __init__(self, in_channels, out_channels, temporal=False, temporal_sequence=0, device=None):
        super(TDKNLRGAN_G, self).__init__()
        ...
        if self.temporal:
            ...
            self.nl_block = DilatedKronNLBlockND(in_channels=512, mode='embedded', dimension=3, bn_layer=True,device=device)
